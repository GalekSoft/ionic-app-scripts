    ...
    return new Promise(function (resolve, reject) {
        ...
        worker.on('message', function (msg) {
            if (msg.error) {
                ...
                var buildError = (0, helpers_1.jsonToBuildError)(msg.reject);
                reject(buildError);
            }
            else {
                resolve(msg.resolve);
...
function createWorker(taskModule) {
    ...
    try {
        var workerModule = (0, path_1.join)(__dirname, 'worker-process.js');
        var worker = (0, child_process_1.fork)(workerModule, process.argv, {
            env: {
                FORCE_COLOR: true,
