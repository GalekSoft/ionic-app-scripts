...
var FileSystemCompilerHost = /** @class */ (function () {
    function FileSystemCompilerHost(options, fileSystem, setParentNodes) {
        ...
        this.diskCompilerHost = (0, typescript_1.createCompilerHost)(this.options, this.setParentNodes);
    }
    ...
    FileSystemCompilerHost.prototype.directoryExists = function (directoryPath) {
        directoryPath = (0, path_1.normalize)(directoryPath);
    ...
    FileSystemCompilerHost.prototype.getSourceFile = function (filePath, languageVersion, onError) {
        ...
        if (fileContentFromMemory) {
            var typescriptSourceFile = (0, typescript_utils_1.getTypescriptSourceFile)(filePath, fileContentFromMemory, languageVersion, this.setParentNodes);
