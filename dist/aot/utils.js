...
function replaceNgModuleClassName(filePath, fileContent, className) {
    var sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)(filePath, fileContent, typescript_1.ScriptTarget.Latest, false);
    var allCalls = (0, typescript_utils_1.findNodes)(sourceFile, sourceFile, typescript_1.SyntaxKind.CallExpression, true);
    ...
    allCalls.filter(function (call) { return bootstraps.some(function (bs) { return bs === call.expression; }); }).forEach(function (call) {
        modifiedContent = (0, typescript_utils_1.replaceNode)(filePath, modifiedContent, call.arguments[0], className + 'NgFactory');
    });
...
function replacePlatformBrowser(filePath, fileContent) {
    ...
    var calls = bootstraps.reduce(function (previous, access) {
        var expressions = (0, typescript_utils_1.findNodes)(sourceFile, access, typescript_1.SyntaxKind.CallExpression, true);
    ...
    calls.forEach(function (call) {
        modifiedContent = (0, typescript_utils_1.replaceNode)(filePath, modifiedContent, call.expression, 'platformBrowser');
    });
    return modifiedContent;
}
...
function replaceBootstrapModuleFactory(filePath, fileContent) {
    ...
    bootstraps.forEach(function (bs) {
        modifiedContent = (0, typescript_utils_1.replaceNode)(filePath, modifiedContent, bs.name, 'bootstrapModuleFactory');
    });
    return modifiedContent;
}
function getPlatformBrowserFunctionNode(filePath, fileContent) {
    var modifiedFileContent = fileContent;
    var sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)(filePath, modifiedFileContent, typescript_1.ScriptTarget.Latest, false);
    var allCalls = (0, typescript_utils_1.findNodes)(sourceFile, sourceFile, typescript_1.SyntaxKind.CallExpression, true);
    ...
    if (callsToPlatformBrowser.length) {
        modifiedFileContent = (0, typescript_utils_1.appendBefore)(filePath, modifiedFileContent, callsToPlatformBrowser[0].expression, toAppend);
    }
    else {
...
function importAndEnableProdMode(filePath, fileContent) {
    var modifiedFileContent = fileContent;
    modifiedFileContent = (0, typescript_utils_1.insertNamedImportIfNeeded)(filePath, modifiedFileContent, 'enableProdMode', '@angular/core');
    var isCalled = (0, typescript_utils_1.checkIfFunctionIsCalled)(filePath, modifiedFileContent, 'enableProdMode');
    if (!isCalled) {
...
function replaceBootstrapImpl(filePath, fileContent, appNgModulePath, appNgModuleClassName) {
    ...
    var withoutExtension = (0, path_1.join)((0, path_1.dirname)(appNgModulePath), (0, path_1.basename)(appNgModulePath, '.ts'));
    var appModuleAbsoluteFileName = (0, path_1.normalize)((0, path_1.resolve)(withoutExtension));
    var withNgFactory = appModuleAbsoluteFileName + '.ngfactory';
    var originalImport = './' + (0, path_1.relative)((0, path_1.dirname)(filePath), appModuleAbsoluteFileName);
    var ngFactryImport = './' + (0, path_1.relative)((0, path_1.dirname)(filePath), withNgFactory);
    ...
    modifiedFileContent = (0, typescript_utils_1.replaceNamedImport)(filePath, modifiedFileContent, 'platformBrowserDynamic', 'platformBrowser');
    modifiedFileContent = (0, typescript_utils_1.replaceNamedImport)(filePath, modifiedFileContent, appNgModuleClassName, appNgModuleClassName + 'NgFactory');
    modifiedFileContent = (0, typescript_utils_1.replaceImportModuleSpecifier)(filePath, modifiedFileContent, '@angular/platform-browser-dynamic', '@angular/platform-browser');
    modifiedFileContent = (0, typescript_utils_1.replaceImportModuleSpecifier)(filePath, modifiedFileContent, originalImport, ngFactryImport);
