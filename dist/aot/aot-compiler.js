...
function runAot(context, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tsConfig = (0, transpile_1.getTsConfig)(context);
                    ...
                    fileSystem = (0, hybrid_file_system_factory_1.getInstance)(false);
                    compilerHost = (0, compiler_host_factory_1.getFileSystemCompilerHostInstance)(tsConfig.options);
                    tsProgram = (0, typescript_1.createProgram)(tsConfig.fileNames, tsConfig.options, compilerHost);
                ...
                case 4:
                    ...
                    mailFilePath = isNg5(context.angularVersion) ? (0, helpers_1.changeExtension)(options.entryPoint, '.js') : options.entryPoint;
...
function errorCheckProgram(context, tsConfig, compilerHost, cachedProgram) {
    ...
    var program = (0, typescript_1.createProgram)(tsConfig.fileNames, tsConfig.options, compilerHost, cachedProgram);
    ...
    if (globalDiagnostics.length) {
        var diagnostics = (0, logger_typescript_1.runTypeScriptDiagnostics)(context, globalDiagnostics);
        (0, logger_diagnostics_1.printDiagnostics)(context, logger_diagnostics_1.DiagnosticsType.TypeScript, diagnostics, true, false);
...
function replaceBootstrap(mainFile, appNgModulePath, appNgModuleClass, options) {
    ...
    try {
        ...
        modifiedFileContent = (0, utils_1.replaceBootstrapImpl)(mainFile.path, mainFile.content, appNgModulePath, appNgModuleClass);
    }
    catch (ex) {
        ...
        modifiedFileContent = (0, utils_1.getFallbackMainContent)();
    }
...
function transpileFiles(context, tsConfig, fileSystem) {
    var tsFiles = context.fileCache.getAll().filter(function (file) { return (0, path_1.extname)(file.path) === '.ts' && file.path.indexOf('.d.ts') === -1; });
    for (var _i = 0, tsFiles_1 = tsFiles; _i < tsFiles_1.length; _i++) {
        ...
        var jsFilePath = (0, helpers_1.changeExtension)(tsFile.path, '.js');
...
function transpileFileContent(fileName, sourceText, options) {
    ...
    return (0, typescript_1.transpileModule)(sourceText, transpileOptions);
}
                ...
                case 1:
                    ...
                    return [4 /*yield*/, module.__NGTOOLS_PRIVATE_API_2.codeGen({
                            ...
                            readResource: function (fileName) {
                                return (0, helpers_1.readFileAsync)(fileName);
                            }
                        })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (tsDiagnostics.length) {
                        diagnostics = (0, logger_typescript_1.runTypeScriptDiagnostics)(context, tsDiagnostics);
                        (0, logger_diagnostics_1.printDiagnostics)(context, logger_diagnostics_1.DiagnosticsType.TypeScript, diagnostics, true, false);
                        throw new errors_1.BuildError(new Error('The Angular AoT build failed. See the issues above'));
                    }
                    if (angularDiagnostics.length) {
                        diagnostics = (0, logger_typescript_1.runTypeScriptDiagnostics)(context, angularDiagnostics);
                        (0, logger_diagnostics_1.printDiagnostics)(context, logger_diagnostics_1.DiagnosticsType.TypeScript, diagnostics, true, false);
                        throw new errors_1.BuildError(new Error('The Angular AoT build failed. See the issues above'));
                    }
                    return [2 /*return*/];
