...
exports.createLinter = exports.getTsLintConfig = exports.getFileNames = exports.createProgram = exports.typeCheck = exports.getLintResult = exports.lint = void 0;
...
function typeCheck(context, program, linterOptions) {
    if ((0, util_1.isObject)(linterOptions) && linterOptions.typeCheck) {
        return Promise.resolve((0, typescript_1.getPreEmitDiagnostics)(program));
    }
...
function getTsLintConfig(tsLintConfig, linterOptions) {
    ...
    Object.assign(config, (0, util_1.isObject)(linterOptions) ? { linterOptions: linterOptions } : {});
    return config;
}
