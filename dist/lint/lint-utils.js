...
function lintFiles(context, program, tsLintConfig, filePaths, linterOptions) {
    var linter = (0, lint_factory_1.createLinter)(context, program);
    var config = (0, lint_factory_1.getTsLintConfig)(tsLintConfig, linterOptions);
    return (0, lint_factory_1.typeCheck)(context, program, linterOptions)
        ...
        .then(function () { return (0, lint_factory_1.getLintResult)(linter); })
...
function lintFile(linter, config, filePath) {
    ...
    return (0, helpers_1.readFileAsync)(filePath)
        .then(function (fileContents) { return (0, lint_factory_1.lint)(linter, config, filePath, fileContents); });
}
...
function processLintResult(context, result) {
    ...
    if (result.errorCount !== 0 || result.warningCount !== 0) {
        var diagnostics = (0, logger_tslint_1.runTsLintDiagnostics)(context, result.failures);
        (0, logger_diagnostics_1.printDiagnostics)(context, logger_diagnostics_1.DiagnosticsType.TsLint, diagnostics, true, false);
