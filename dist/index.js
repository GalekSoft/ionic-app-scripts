...
exports.run = exports.getDeepLinkData = exports.buildUpdate = exports.watch = exports.uglifyjs = exports.transpile = exports.serve = exports.sassUpdate = exports.sass = exports.ngc = exports.minify = exports.lint = exports.copyUpdate = exports.copy = exports.cleancss = exports.clean = exports.bundleUpdate = exports.bundle = exports.build = void 0;
...
function run(task) {
    try {
        logger_1.Logger.info("ionic-app-scripts " + (0, helpers_1.getAppScriptsVersion)(), 'cyan');
    }
    catch (e) { }
    try {
        var context = (0, config_1.generateContext)(null);
