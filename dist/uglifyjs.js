...
function uglifyjs(context, configFile) {
    ...
    var logger = new logger_1.Logger('uglify');
    return (0, worker_client_1.runWorker)('uglifyjs', 'uglifyjsWorker', context, configFile)
        .then(function () {
        logger.finish();
    })
        .catch(function (err) {
...
function uglifyjsWorker(context, configFile) {
    var uglifyJsConfig = (0, config_1.fillConfigDefaults)(configFile, exports.taskInfo.defaultConfigFile);
    if (!context) {
...
function runUglifyInternal(sourceFilePath, destFilePath, sourceMapPath, destMapPath, configObject) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, sourceFileContent, sourceMapContent, uglifyConfig, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.all([(0, helpers_1.readFileAsync)(sourceFilePath), (0, helpers_1.readFileAsync)(sourceMapPath)])];
                case 1:
                    ...
                    return [2 /*return*/, Promise.all([(0, helpers_1.writeFileAsync)(destFilePath, result.code), (0, helpers_1.writeFileAsync)(destMapPath, result.map)])];
            }
        });
    });
}
