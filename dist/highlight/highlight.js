...
exports.highlight = exports.highlightError = void 0;
var hljs = {};
...
function highlightError(htmlInput, errorCharStart, errorLength) {
    if (errorCharStart < 0 || errorLength < 1 || !htmlInput)
        return htmlInput;
    var chars = htmlInput.split('');
    var inTag = false;
    var textIndex = -1;
    for (var htmlIndex = 0; htmlIndex < chars.length; htmlIndex++) {
        if (chars[htmlIndex] === '<') {
            ...
            if (isValidEscape) {
                ...
                for (var i_1 = 0; i_1 < escapeChars.length - 1; i_1++) {
...
function highlight(name, value, ignore_illegals, continuation) {
    ...
    function startNewMode(mode, asdf) {
