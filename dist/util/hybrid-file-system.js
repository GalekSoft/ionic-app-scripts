...
var HybridFileSystem = /** @class */ (function () {
    ...
    HybridFileSystem.prototype.addVirtualFile = function (filePath, fileContent) {
        ...
        var directoryPath = (0, path_1.dirname)(filePath);
    ...
    HybridFileSystem.prototype.getSubDirs = function (directoryPath) {
        return Object.keys(this.directoryStats)
            .filter(function (filePath) { return (0, path_1.dirname)(filePath) === directoryPath; })
            .map(function (filePath) { return (0, path_1.basename)(directoryPath); });
    };
    HybridFileSystem.prototype.getFileNamesInDirectory = function (directoryPath) {
        return Object.keys(this.filesStats).filter(function (filePath) { return (0, path_1.dirname)(filePath) === directoryPath; }).map(function (filePath) { return (0, path_1.basename)(filePath); });
    };
    ...
    HybridFileSystem.prototype.join = function (dirPath, fileName) {
        return (0, path_1.join)(dirPath, fileName);
    };
