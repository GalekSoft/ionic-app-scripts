...
function getAppScriptsPackageJson() {
    if (!cachedAppScriptsPackageJson) {
        try {
            cachedAppScriptsPackageJson = (0, fs_extra_1.readJsonSync)((0, path_1.join)(__dirname, '..', '..', 'package.json'));
        }
        catch (e) { }
    }
...
function getUserPackageJson(userRootDir) {
    try {
        return (0, fs_extra_1.readJsonSync)((0, path_1.join)(userRootDir, 'package.json'));
    }
    catch (e) { }
    return null;
}
...
function writeFileAsync(filePath, content) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.writeFile)(filePath, content, function (err) {
            if (err) {
                return reject(err);
            }
...
function readFileAsync(filePath) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.readFile)(filePath, 'utf-8', function (err, buffer) {
            if (err) {
                return reject(err);
            }
...
function readJsonAsync(filePath) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.readJson)(filePath, {}, function (err, object) {
            if (err) {
                return reject(err);
            }
...
function unlinkAsync(filePath) {
    ...
    var promises = filePaths.map(function (filePath) {
        return new Promise(function (resolve, reject) {
            (0, fs_extra_1.unlink)(filePath, function (err) {
                if (err) {
                    return reject(err);
                }
                return resolve();
...
function rimRafAsync(directoryPath) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.remove)(directoryPath, function (err) {
            if (err) {
                return reject(err);
            }
            return resolve();
...
function copyFileAsync(srcPath, destPath) {
    return new Promise(function (resolve, reject) {
        var writeStream = (0, fs_extra_1.createWriteStream)(destPath);
        ...
        (0, fs_extra_1.createReadStream)(srcPath).pipe(writeStream);
    });
}
exports.copyFileAsync = copyFileAsync;
function mkDirpAsync(directoryPath) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.ensureDir)(directoryPath, function (err) {
            if (err) {
                return reject(err);
            }
            return resolve(function () { });
...
function readDirAsync(pathToDir) {
    return new Promise(function (resolve, reject) {
        (0, fs_extra_1.readdir)(pathToDir, function (err, fileNames) {
            if (err) {
                return reject(err);
            }
            resolve(fileNames);
...
function changeExtension(filePath, newExtension) {
    ...
    var extensionlessfileName = (0, path_1.basename)(filePath, extension);
...
function generateRandomHexString(numCharacters) {
    return (0, crypto_1.randomBytes)(Math.ceil(numCharacters / 2)).toString('hex').slice(0, numCharacters);
}
...
function convertFilePathToNgFactoryPath(filePath) {
    ...
    return (0, path_1.join)(directory, ngFactoryFileName);
}
