    ...
    return new Promise(function (resolve, reject) {
        globFunction(task.pattern, task.opts, function (err, files) {
            ...
            var globResults = files.map(function (file) {
                return {
                    absolutePath: (0, path_1.normalize)((0, path_1.resolve)(file)),
                    base: (0, path_1.normalize)((0, path_1.resolve)(getBasePath(task.pattern)))
                };
            });
...
function toAbsoluteGlob(pattern) {
    var cwd = (0, helpers_1.toUnixPath)(process.cwd());
    ...
    pattern = ing.pattern;
    if (!(0, path_1.isAbsolute)(pattern) || pattern.slice(0, 1) === '\\') {
        pattern = (0, path_1.join)(cwd, pattern);
    }
...
function globParent(pattern) {
    ...
    do {
        pattern = (0, helpers_1.toUnixPath)((0, path_1.dirname)(pattern));
