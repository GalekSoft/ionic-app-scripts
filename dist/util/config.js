...
exports.setAppPackageJsonData = exports.getPackageJsonConfig = exports.setCwd = exports.getProcessEnvVar = exports.setProcessEnvVar = exports.setProcessEnv = exports.addArgv = exports.setProcessArgs = exports.isDebugMode = exports.getNodeBinExecutable = exports.replacePathVars = exports.hasArg = exports.hasConfigValue = exports.getConfigValue = exports.bundlerStrategy = exports.fillConfigDefaults = exports.getUserConfigFile = exports.generateContext = void 0;
...
function generateContext(context) {
    ...
    setProcessEnvVar(Constants.ENV_VAR_IONIC_MINIFY_JS, "" + context.runMinifyJs);
    logger_1.Logger.debug(Constants.ENV_VAR_IONIC_MINIFY_JS + " set to " + context.runMinifyJs);
    context.rootDir = (0, path_1.resolve)(context.rootDir || getConfigValue(context, '--rootDir', null, Constants.ENV_VAR_ROOT_DIR, Constants.ENV_VAR_ROOT_DIR.toLowerCase(), processCwd));
    setProcessEnvVar(Constants.ENV_VAR_ROOT_DIR, context.rootDir);
    logger_1.Logger.debug("rootDir set to " + context.rootDir);
    context.tmpDir = (0, path_1.resolve)(context.tmpDir || getConfigValue(context, '--tmpDir', null, Constants.ENV_VAR_TMP_DIR, Constants.ENV_VAR_TMP_DIR.toLowerCase(), (0, path_1.join)(context.rootDir, Constants.TMP_DIR)));
    setProcessEnvVar(Constants.ENV_VAR_TMP_DIR, context.tmpDir);
    logger_1.Logger.debug("tmpDir set to " + context.tmpDir);
    context.srcDir = (0, path_1.resolve)(context.srcDir || getConfigValue(context, '--srcDir', null, Constants.ENV_VAR_SRC_DIR, Constants.ENV_VAR_SRC_DIR.toLowerCase(), (0, path_1.join)(context.rootDir, Constants.SRC_DIR)));
    setProcessEnvVar(Constants.ENV_VAR_SRC_DIR, context.srcDir);
    logger_1.Logger.debug("srcDir set to " + context.srcDir);
    var deepLinksDir = (0, path_1.resolve)(getConfigValue(context, '--deepLinksDir', null, Constants.ENV_VAR_DEEPLINKS_DIR, Constants.ENV_VAR_DEEPLINKS_DIR.toLowerCase(), context.srcDir));
    setProcessEnvVar(Constants.ENV_VAR_DEEPLINKS_DIR, deepLinksDir);
    logger_1.Logger.debug("deepLinksDir set to " + deepLinksDir);
    context.wwwDir = (0, path_1.resolve)(context.wwwDir || getConfigValue(context, '--wwwDir', null, Constants.ENV_VAR_WWW_DIR, Constants.ENV_VAR_WWW_DIR.toLowerCase(), (0, path_1.join)(context.rootDir, Constants.WWW_DIR)));
    ...
    context.buildDir = (0, path_1.resolve)(context.buildDir || getConfigValue(context, '--buildDir', null, Constants.ENV_VAR_BUILD_DIR, Constants.ENV_VAR_BUILD_DIR.toLowerCase(), (0, path_1.join)(context.wwwDir, Constants.BUILD_DIR)));
    setProcessEnvVar(Constants.ENV_VAR_BUILD_DIR, context.buildDir);
    logger_1.Logger.debug("buildDir set to " + context.buildDir);
    var fontsDir = (0, path_1.resolve)(getConfigValue(context, '--fontsDir', null, Constants.ENV_VAR_FONTS_DIR, Constants.ENV_VAR_FONTS_DIR.toLowerCase(), (0, path_1.join)(context.wwwDir, 'assets', 'fonts')));
    setProcessEnvVar(Constants.ENV_VAR_FONTS_DIR, fontsDir);
    logger_1.Logger.debug("fontsDir set to " + fontsDir);
    context.sourcemapDir = (0, path_1.resolve)(context.sourcemapDir || getConfigValue(context, '--sourcemapDir', null, Constants.ENV_VAR_SOURCEMAP_DIR, Constants.ENV_VAR_SOURCEMAP_DIR.toLowerCase(), Constants.SOURCEMAP_DIR));
    ...
    context.pagesDir = (0, path_1.resolve)(context.pagesDir || getConfigValue(context, '--pagesDir', null, Constants.ENV_VAR_PAGES_DIR, Constants.ENV_VAR_PAGES_DIR.toLowerCase(), (0, path_1.join)(context.srcDir, 'pages')));
    setProcessEnvVar(Constants.ENV_VAR_PAGES_DIR, context.pagesDir);
    logger_1.Logger.debug("pagesDir set to " + context.pagesDir);
    context.componentsDir = (0, path_1.resolve)(context.componentsDir || getConfigValue(context, '--componentsDir', null, Constants.ENV_VAR_COMPONENTS_DIR, Constants.ENV_VAR_COMPONENTS_DIR.toLowerCase(), (0, path_1.join)(context.srcDir, 'components')));
    ...
    context.directivesDir = (0, path_1.resolve)(context.directivesDir || getConfigValue(context, '--directivesDir', null, Constants.ENV_VAR_DIRECTIVES_DIR, Constants.ENV_VAR_DIRECTIVES_DIR.toLowerCase(), (0, path_1.join)(context.srcDir, 'directives')));
    ...
    context.pipesDir = (0, path_1.resolve)(context.pipesDir || getConfigValue(context, '--pipesDir', null, Constants.ENV_VAR_PIPES_DIR, Constants.ENV_VAR_PIPES_DIR.toLowerCase(), (0, path_1.join)(context.srcDir, 'pipes')));
    setProcessEnvVar(Constants.ENV_VAR_PIPES_DIR, context.pipesDir);
    logger_1.Logger.debug("pipesDir set to " + context.pipesDir);
    context.providersDir = (0, path_1.resolve)(context.providersDir || getConfigValue(context, '--providersDir', null, Constants.ENV_VAR_PROVIDERS_DIR, Constants.ENV_VAR_PROVIDERS_DIR.toLowerCase(), (0, path_1.join)(context.srcDir, 'providers')));
    ...
    context.nodeModulesDir = (0, path_1.join)(context.rootDir, Constants.NODE_MODULES);
    ...
    context.ionicAngularDir = (0, path_1.resolve)(context.ionicAngularDir || getConfigValue(context, '--ionicAngularDir', null, Constants.ENV_VAR_IONIC_ANGULAR_DIR, Constants.ENV_VAR_IONIC_ANGULAR_DIR.toLowerCase(), (0, path_1.join)(context.nodeModulesDir, Constants.IONIC_ANGULAR)));
    ...
    var angularDir = (0, path_1.resolve)(getConfigValue(context, '--angularDir', null, Constants.ENV_VAR_ANGULAR_CORE_DIR, Constants.ENV_VAR_ANGULAR_CORE_DIR.toLowerCase(), (0, path_1.join)(context.nodeModulesDir, Constants.AT_ANGULAR, 'core')));
    ...
    var typescriptDir = (0, path_1.resolve)(getConfigValue(context, '--typescriptDir', null, Constants.ENV_VAR_TYPESCRIPT_DIR, Constants.ENV_VAR_TYPESCRIPT_DIR.toLowerCase(), (0, path_1.join)(context.nodeModulesDir, Constants.TYPESCRIPT)));
    ...
    var defaultCoreCompilerFilePath = (0, path_1.join)(context.ionicAngularDir, 'compiler');
    context.coreCompilerFilePath = (0, path_1.resolve)(context.coreCompilerFilePath || getConfigValue(context, '--coreCompilerFilePath', null, Constants.ENV_VAR_CORE_COMPILER_FILE_PATH, Constants.ENV_VAR_CORE_COMPILER_FILE_PATH.toLowerCase(), defaultCoreCompilerFilePath));
    ...
    context.coreDir = (0, path_1.resolve)(context.coreDir || getConfigValue(context, '--coreDir', null, Constants.ENV_VAR_CORE_DIR, Constants.ENV_VAR_CORE_DIR.toLowerCase(), defaultCoreDir));
    setProcessEnvVar(Constants.ENV_VAR_CORE_DIR, context.coreDir);
    logger_1.Logger.debug("coreDir set to " + context.coreDir);
    var rxjsDir = (0, path_1.resolve)(getConfigValue(context, '--rxjsDir', null, Constants.ENV_VAR_RXJS_DIR, Constants.ENV_VAR_RXJS_DIR.toLowerCase(), (0, path_1.join)(context.nodeModulesDir, Constants.RXJS)));
    setProcessEnvVar(Constants.ENV_VAR_RXJS_DIR, rxjsDir);
    logger_1.Logger.debug("rxjsDir set to " + rxjsDir);
    var ionicAngularTemplatesDir = (0, path_1.join)(context.ionicAngularDir, 'templates');
    ...
    var ionicAngularEntryPoint = (0, path_1.resolve)(getConfigValue(context, '--ionicAngularEntryPoint', null, Constants.ENV_VAR_IONIC_ANGULAR_ENTRY_POINT, Constants.ENV_VAR_IONIC_ANGULAR_ENTRY_POINT.toLowerCase(), (0, path_1.join)(context.ionicAngularDir, 'index.js')));
    ...
    var appScriptsDir = (0, path_1.join)(__dirname, '..', '..');
    ...
    var tsConfigPathValue = (0, path_1.resolve)(getConfigValue(context, '--tsconfig', null, Constants.ENV_TS_CONFIG, Constants.ENV_TS_CONFIG.toLowerCase(), (0, path_1.join)(context.rootDir, 'tsconfig.json')));
    ...
    var appEntryPointPathValue = (0, path_1.resolve)(getConfigValue(context, '--appEntryPoint', null, Constants.ENV_APP_ENTRY_POINT, Constants.ENV_APP_ENTRY_POINT.toLowerCase(), (0, path_1.join)(context.srcDir, 'app', 'main.ts')));
    ...
    context.appNgModulePath = (0, path_1.resolve)(getConfigValue(context, '--appNgModulePath', null, Constants.ENV_APP_NG_MODULE_PATH, Constants.ENV_APP_NG_MODULE_PATH.toLowerCase(), (0, path_1.join)(context.srcDir, 'app', 'app.module.ts')));
    ...
    context.componentsNgModulePath = (0, path_1.resolve)(getConfigValue(context, '--componentsNgModulePath', null, Constants.ENV_COMPONENTS_NG_MODULE_PATH, Constants.ENV_COMPONENTS_NG_MODULE_PATH.toLowerCase(), (0, path_1.join)(context.srcDir, 'components', 'components.module.ts')));
    ...
    context.pipesNgModulePath = (0, path_1.resolve)(getConfigValue(context, '--pipesNgModulePath', null, Constants.ENV_PIPES_NG_MODULE_PATH, Constants.ENV_PIPES_NG_MODULE_PATH.toLowerCase(), (0, path_1.join)(context.srcDir, 'pipes', 'pipes.module.ts')));
    ...
    context.directivesNgModulePath = (0, path_1.resolve)(getConfigValue(context, '--directivesNgModulePath', null, Constants.ENV_DIRECTIVES_NG_MODULE_PATH, Constants.ENV_DIRECTIVES_NG_MODULE_PATH.toLowerCase(), (0, path_1.join)(context.srcDir, 'directives', 'directives.module.ts')));
    ...
    var pathToGlobUtil = (0, path_1.join)(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'util', 'glob-util.js');
    ...
    var webpackFactoryPath = (0, path_1.join)(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'webpack', 'ionic-webpack-factory.js');
    ...
    var webpackLoaderPath = (0, path_1.join)(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'webpack', 'loader.js');
    ...
    var cacheLoaderPath = (0, path_1.join)(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'webpack', 'cache-loader.js');
    ...
    setProcessEnvVar(Constants.ENV_ACTION_SHEET_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'action-sheet', 'action-sheet-controller.js'));
    setProcessEnvVar(Constants.ENV_ACTION_SHEET_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'action-sheet', 'action-sheet.js'));
    setProcessEnvVar(Constants.ENV_ACTION_SHEET_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'action-sheet', 'action-sheet-component.js'));
    setProcessEnvVar(Constants.ENV_ACTION_SHEET_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'action-sheet', 'action-sheet-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_ALERT_CONTROLLER_CLASSNAME, 'AlertController');
    setProcessEnvVar(Constants.ENV_ALERT_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'alert', 'alert-controller.js'));
    setProcessEnvVar(Constants.ENV_ALERT_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'alert', 'alert.js'));
    setProcessEnvVar(Constants.ENV_ALERT_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'alert', 'alert-component.js'));
    setProcessEnvVar(Constants.ENV_ALERT_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'alert', 'alert-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_APP_ROOT_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'app', 'app-root.js'));
    setProcessEnvVar(Constants.ENV_LOADING_CONTROLLER_CLASSNAME, 'LoadingController');
    setProcessEnvVar(Constants.ENV_LOADING_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'loading', 'loading-controller.js'));
    setProcessEnvVar(Constants.ENV_LOADING_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'loading', 'loading.js'));
    setProcessEnvVar(Constants.ENV_LOADING_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'loading', 'loading-component.js'));
    setProcessEnvVar(Constants.ENV_LOADING_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'loading', 'loading-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_MODAL_CONTROLLER_CLASSNAME, 'ModalController');
    setProcessEnvVar(Constants.ENV_MODAL_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'modal', 'modal-controller.js'));
    setProcessEnvVar(Constants.ENV_MODAL_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'modal', 'modal.js'));
    setProcessEnvVar(Constants.ENV_MODAL_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'modal', 'modal-component.js'));
    setProcessEnvVar(Constants.ENV_MODAL_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'modal', 'modal-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_PICKER_CONTROLLER_CLASSNAME, 'PickerController');
    setProcessEnvVar(Constants.ENV_PICKER_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'picker', 'picker-controller.js'));
    setProcessEnvVar(Constants.ENV_PICKER_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'picker', 'picker.js'));
    setProcessEnvVar(Constants.ENV_PICKER_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'picker', 'picker-component.js'));
    setProcessEnvVar(Constants.ENV_PICKER_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'picker', 'picker-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_POPOVER_CONTROLLER_CLASSNAME, 'PopoverController');
    setProcessEnvVar(Constants.ENV_POPOVER_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'popover', 'popover-controller.js'));
    setProcessEnvVar(Constants.ENV_POPOVER_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'popover', 'popover.js'));
    setProcessEnvVar(Constants.ENV_POPOVER_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'popover', 'popover-component.js'));
    setProcessEnvVar(Constants.ENV_POPOVER_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'popover', 'popover-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_SELECT_POPOVER_CLASSNAME, 'SelectPopover');
    setProcessEnvVar(Constants.ENV_SELECT_POPOVER_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'select', 'select-popover-component.js'));
    setProcessEnvVar(Constants.ENV_SELECT_POPOVER_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'select', 'select-popover-component.ngfactory.js'));
    setProcessEnvVar(Constants.ENV_TOAST_CONTROLLER_CLASSNAME, 'ToastController');
    setProcessEnvVar(Constants.ENV_TOAST_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'toast', 'toast-controller.js'));
    setProcessEnvVar(Constants.ENV_TOAST_VIEW_CONTROLLER_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'toast', 'toast.js'));
    setProcessEnvVar(Constants.ENV_TOAST_COMPONENT_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'toast', 'toast-component.js'));
    setProcessEnvVar(Constants.ENV_TOAST_COMPONENT_FACTORY_PATH, (0, path_1.join)(context.ionicAngularDir, 'components', 'toast', 'toast-component.ngfactory.js'));
    ...
    checkDebugMode();
    if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_DISABLE_LOGGING)) {
...
function fillConfigDefaults(userConfigFile, defaultConfigFile) {
    ...
    if (userConfigFile) {
        try {
            ...
            (0, fs_extra_1.statSync)(userConfigFile);
    ...
    var defaultConfig = require((0, path_1.join)('..', '..', 'config', defaultConfigFile));
    // create a fresh copy of the config each time
    // always assign any default values which were not already supplied by the user
    return (0, helpers_1.objectAssign)({}, defaultConfig, userConfig);
}
...
function getNodeBinExecutable(context, cmd) {
    var cmdPath = (0, path_1.join)(context.rootDir, 'node_modules', '.bin', cmd);
    try {
        (0, fs_extra_1.accessSync)(cmdPath);
    }
    catch (e) {
        cmdPath = null;
    }
...
function getAppPackageJsonData(context) {
    if (!appPackageJsonData) {
        try {
            appPackageJsonData = (0, fs_extra_1.readJSONSync)((0, path_1.join)(context.rootDir, 'package.json'));
        }
        catch (e) { }
    }
