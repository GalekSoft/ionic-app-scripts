...
function webpackLoader(source, map, webpackContex) {
    ...
    var absolutePath = (0, path_1.resolve)((0, path_1.normalize)(webpackContex.resourcePath));
    logger_1.Logger.debug("[Webpack] webpackLoader: processing the following file: " + absolutePath);
    var javascriptPath = (0, helpers_1.changeExtension)(absolutePath, '.js');
...
function readFile(fileCache, filePath) {
    return (0, helpers_1.readAndCacheFile)(filePath).then(function (fileContent) {
