...
var WatchMemorySystem = /** @class */ (function () {
    ...
    WatchMemorySystem.prototype.startListening = function () {
        ...
        (0, events_1.on)(events_1.EventType.WebpackFilesChanged, function () {
            _this.changes = new Set();
            var filePaths = _this.fileCache.getAll().filter(function (file) { return file.timestamp >= _this.lastWatchEventTimestamp && file.path.startsWith(_this.srcDir) && (0, path_1.extname)(file.path) === '.ts'; }).map(function (file) { return file.path; });
