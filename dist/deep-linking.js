...
function deepLinking(context) {
    ...
    return deepLinkingWorker(context).then(function (map) {
        (0, helpers_1.setParsedDeepLinkConfig)(map);
        logger.finish();
    })
        .catch(function (err) {
...
function deepLinkingWorkerImpl(context, changedFiles) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    appNgModulePath = (0, helpers_1.getStringPropertyValue)(Constants.ENV_APP_NG_MODULE_PATH);
                    return [4 /*yield*/, getAppMainNgModuleFile(appNgModulePath)];
                case 1:
                    appNgModuleFileContent = _a.sent();
                    hasExisting = (0, util_1.hasExistingDeepLinkConfig)(appNgModulePath, appNgModuleFileContent);
                    if (hasExisting) {
                        return [2 /*return*/, new Map()];
                    }
                    results = (0, util_1.getDeepLinkData)(appNgModulePath, context.fileCache, context.runAot) || new Map();
                    newDeepLinkString = (0, util_1.convertDeepLinkConfigEntriesToString)(results);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, helpers_1.readAndCacheFile)(appNgModulePath)];
