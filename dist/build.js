    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promises = [];
                    promises.push((0, util_1.validateRequiredFilesExist)(context));
                    promises.push((0, util_1.readVersionOfDependencies)(context));
                    return [4 /*yield*/, Promise.all(promises)];
                case 1:
                    results = _a.sent();
                    tsConfigContents = results[0][1];
                    return [4 /*yield*/, (0, util_1.validateTsConfigSettings)(tsConfigContents)];
                case 2:
                    _a.sent();
...
function buildProject(context) {
    ...
    (0, clean_1.clean)(context);
    buildId++;
    var copyPromise = (0, copy_1.copy)(context);
    return (0, util_1.scanSrcTsFiles)(context)
        .then(function () {
        if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_PARSE_DEEPLINKS)) {
            return (0, deep_linking_1.deepLinking)(context);
        }
    })
        .then(function () {
        var compilePromise = (context.runAot) ? (0, ngc_1.ngc)(context) : (0, transpile_1.transpile)(context);
        return compilePromise;
    })
        .then(function () {
        return (0, preprocess_1.preprocess)(context);
    })
        .then(function () {
        return (0, bundle_1.bundle)(context);
    })
        .then(function () {
        var minPromise = (context.runMinifyJs) ? (0, minify_1.minifyJs)(context) : Promise.resolve();
        var sassPromise = (0, sass_1.sass)(context)
            .then(function () {
            return (context.runMinifyCss) ? (0, minify_1.minifyCss)(context) : Promise.resolve();
        });
        return Promise.all([
            minPromise,
            sassPromise,
        ...
        .then(function () {
        return (0, postprocess_1.postprocess)(context);
    })
        .then(function () {
        if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_ENABLE_LINT)) {
            // kick off the tslint after everything else
            // nothing needs to wait on its completion unless bailing on lint error is enabled
            var result = (0, lint_1.lint)(context, null, false);
            if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_BAIL_ON_LINT_ERROR)) {
                return result;
            }
        }
    })
...
function buildUpdate(changedFiles, context) {
    return new Promise(function (resolve) {
        ...
        (0, events_1.emit)(events_1.EventType.BuildUpdateStarted, buildUpdateMsg);
        function buildTasksDone(resolveValue) {
            ...
            parallelTasksPromise.then(function () {
                ...
                (0, events_1.emit)(events_1.EventType.BuildUpdateCompleted, buildUpdateMsg);
                if (!resolveValue.requiresAppReload) {
                    ...
                    (0, events_1.emit)(events_1.EventType.FileChange, resolveValue.changedFiles);
                }
                ...
                if (requiresLintUpdate) {
                    ...
                    if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_ENABLE_LINT)) {
                        (0, lint_1.lintUpdate)(changedFiles, context, false);
                    }
                }
...
function buildUpdateTasks(changedFiles, context) {
    ...
    return loadFiles(changedFiles, context)
        ...
        // DEEP LINKING
        if ((0, helpers_1.getBooleanPropertyValue)(Constants.ENV_PARSE_DEEPLINKS)) {
            return (0, deep_linking_1.deepLinkingUpdate)(changedFiles, context);
        }
    })
        .then(function () {
        // TEMPLATE
        if (context.templateState === interfaces_1.BuildState.RequiresUpdate) {
            ...
            return (0, template_1.templateUpdate)(changedFiles, context);
        }
        ...
        if (context.transpileState === interfaces_1.BuildState.RequiresUpdate) {
            ...
            return (0, transpile_1.transpileUpdate)(changedFiles, context);
        }
        else if (context.transpileState === interfaces_1.BuildState.RequiresBuild) {
            // run the whole transpile
            resolveValue.requiresAppReload = true;
            return (0, transpile_1.transpile)(context);
        }
        ...
        .then(function () {
        // PREPROCESS
        return (0, preprocess_1.preprocessUpdate)(changedFiles, context);
    })
        .then(function () {
        // BUNDLE
        if (context.bundleState === interfaces_1.BuildState.RequiresUpdate) {
            ...
            resolveValue.requiresAppReload = true;
            return (0, bundle_1.bundleUpdate)(changedFiles, context);
        }
        ...
        if (context.sassState === interfaces_1.BuildState.RequiresUpdate) {
            ...
            return (0, sass_1.sassUpdate)(changedFiles, context).then(function (outputCssFile) {
                var changedFile = {
            ...
            return (0, sass_1.sass)(context).then(function (outputCssFile) {
                var changedFile = {
                    event: Constants.FILE_CHANGE_EVENT,
                    ext: '.css',
                    filePath: outputCssFile
...
function loadFiles(changedFiles, context) {
    ...
    var _loop_1 = function (changedFile) {
        if (changedFile.event === Constants.FILE_DELETE_EVENT) {
            ...
            var promise = (0, helpers_1.readFileAsync)(changedFile.filePath);
...
function buildUpdateParallelTasks(changedFiles, context) {
    var parallelTasks = [];
    if (context.transpileState === interfaces_1.BuildState.RequiresUpdate) {
        parallelTasks.push((0, transpile_1.transpileDiagnosticsOnly)(context));
    }
