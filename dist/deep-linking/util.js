...
function isDeepLinkingFile(filePath) {
    var deepLinksDir = (0, helpers_1.getStringPropertyValue)(Constants.ENV_VAR_DEEPLINKS_DIR) + path_1.sep;
    var moduleSuffix = (0, helpers_1.getStringPropertyValue)(Constants.ENV_NG_MODULE_FILE_NAME_SUFFIX);
    var result = (0, path_1.extname)(filePath) === '.ts' && filePath.indexOf(moduleSuffix) === -1 && filePath.indexOf(deepLinksDir) >= 0;
    return result;
}
exports.isDeepLinkingFile = isDeepLinkingFile;
function getNgModulePathFromCorrespondingPage(filePath) {
    var newExtension = (0, helpers_1.getStringPropertyValue)(Constants.ENV_NG_MODULE_FILE_NAME_SUFFIX);
    return (0, helpers_1.changeExtension)(filePath, newExtension);
}
...
function getRelativePathToPageNgModuleFromAppNgModule(pathToAppNgModule, pathToPageNgModule) {
    return (0, path_1.relative)((0, path_1.dirname)(pathToAppNgModule), pathToPageNgModule);
}
...
function getNgModuleDataFromPage(appNgModuleFilePath, filePath, className, fileCache, isAot) {
    ...
    var exportedClassName = (0, typescript_utils_1.getNgModuleClassName)(ngModuleFile.path, ngModuleFile.content);
    var relativePathToAppNgModule = getRelativePathToPageNgModuleFromAppNgModule(appNgModuleFilePath, ngModulePath);
    var absolutePath = isAot ? (0, helpers_1.changeExtension)(ngModulePath, '.ngfactory.js') : (0, helpers_1.changeExtension)(ngModulePath, '.ts');
    var userlandModulePath = isAot ? (0, helpers_1.changeExtension)(relativePathToAppNgModule, '.ngfactory') : (0, helpers_1.changeExtension)(relativePathToAppNgModule, '');
    var namedExport = isAot ? exportedClassName + "NgFactory" : exportedClassName;
    return {
        absolutePath: absolutePath,
        userlandModulePath: (0, helpers_1.toUnixPath)(userlandModulePath),
...
function getDeepLinkDecoratorContentForSourceFile(sourceFile) {
    var classDeclarations = (0, typescript_utils_1.getClassDeclarations)(sourceFile);
    var defaultSegment = (0, path_1.basename)((0, helpers_1.changeExtension)(sourceFile.fileName, ''));
    var list = [];
        ...
        if (classDeclaration.decorators) {
            classDeclaration.decorators.forEach(function (decorator) {
                ...
                if (decorator.expression && decorator.expression.expression && decorator.expression.expression.text === DEEPLINK_DECORATOR_TEXT) {
                    ...
                    var rawStringContent = (0, typescript_utils_1.getNodeStringContent)(sourceFile, decorator.expression);
                    list.push({
                        name: deepLinkName,
    ...
    try {
        ...
        propertyNodeList.forEach(function (propertyNode) {
            if (propertyNode && propertyNode.name && propertyNode.name.text === identifierToLookFor) {
                ...
                var stringContent = (0, typescript_utils_1.getNodeStringContent)(sourceFile, initializer);
                stringContent = (0, helpers_1.replaceAll)(stringContent, '\'', '');
                stringContent = (0, helpers_1.replaceAll)(stringContent, '`', '');
                stringContent = (0, helpers_1.replaceAll)(stringContent, '"', '');
            ...
            if (propertyNode && propertyNode.name && propertyNode.name.text === identifierToLookFor) {
                ...
                if (initializer && initializer.elements) {
                    var stringArray = initializer.elements.map(function (element) {
                        ...
                        elementText = (0, helpers_1.replaceAll)(elementText, '\'', '');
                        elementText = (0, helpers_1.replaceAll)(elementText, '`', '');
                        elementText = (0, helpers_1.replaceAll)(elementText, '"', '');
...
function hasExistingDeepLinkConfig(appNgModuleFilePath, appNgModuleFileContent) {
    var sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)(appNgModuleFilePath, appNgModuleFileContent);
    var decorator = (0, typescript_utils_1.getNgModuleDecorator)(appNgModuleFilePath, sourceFile);
...
function getIonicModuleForRootCall(decorator) {
    var argument = (0, typescript_utils_1.getNgModuleObjectLiteralArg)(decorator);
...
function updateAppNgModuleWithDeepLinkConfig(context, deepLinkString, changedFiles) {
    var appNgModulePath = (0, helpers_1.getStringPropertyValue)(Constants.ENV_APP_NG_MODULE_PATH);
    ...
    if (changedFiles) {
        changedFiles.push({
            ...
            ext: (0, path_1.extname)(appNgModulePath).toLowerCase()
        });
    }
}
...
function getUpdatedAppNgModuleContentWithDeepLinkConfig(appNgModuleFilePath, appNgModuleFileContent, deepLinkStringContent) {
    ...
    if (functionCall.arguments.length === 1) {
        ...
        sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)(appNgModuleFilePath, appNgModuleFileContent);
        decorator = (0, typescript_utils_1.getNgModuleDecorator)(appNgModuleFilePath, sourceFile);
    ...
    return (0, typescript_utils_1.replaceNode)(appNgModuleFilePath, appNgModuleFileContent, functionCall.arguments[2], deepLinkStringContent);
}
...
function addDefaultSecondArgumentToAppNgModule(appNgModuleFileContent, ionicModuleForRoot) {
    ...
    var updatedFileContent = (0, typescript_utils_1.appendAfter)(appNgModuleFileContent, argOneNode, ', {}');
...
function addDeepLinkArgumentToAppNgModule(appNgModuleFileContent, ionicModuleForRoot, deepLinkString) {
    ...
    var updatedFileContent = (0, typescript_utils_1.appendAfter)(appNgModuleFileContent, argTwoNode, ", " + deepLinkString);
    return updatedFileContent;
}
...
function generateDefaultDeepLinkNgModuleContent(pageFilePath, className) {
    var importFrom = (0, path_1.basename)(pageFilePath, '.ts');
...
function purgeDeepLinkDecoratorTSTransformImpl(transformContext) {
    function visitClassDeclaration(classDeclaration) {
        ...
        if (hasDeepLinkDecorator) {
            return (0, typescript_1.updateClassDeclaration)(classDeclaration, diffDecorators, classDeclaration.modifiers, classDeclaration.name, classDeclaration.typeParameters, classDeclaration.heritageClauses, classDeclaration.members);
        }
    ...
    function visitImportDeclaration(importDeclaration, sourceFile) {
        if (importDeclaration.moduleSpecifier
            ...
            var emptyNamedImports = (0, typescript_1.createNamedImports)(importSpecifiers_1);
            var newImportClause = (0, typescript_1.updateImportClause)(importDeclaration.importClause, importDeclaration.importClause.name, emptyNamedImports);
            return (0, typescript_1.updateImportDeclaration)(importDeclaration, importDeclaration.decorators, importDeclaration.modifiers, newImportClause, importDeclaration.moduleSpecifier);
        }
    ...
    function visit(node, sourceFile) {
        switch (node.kind) {
            ...
            default:
                return (0, typescript_1.visitEachChild)(node, function (node) {
...
function purgeDeepLinkDecorator(inputText) {
    var sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)('', inputText);
    var classDeclarations = (0, typescript_utils_1.getClassDeclarations)(sourceFile);
    var toRemove = [];
    ...
    toRemove.forEach(function (node) {
        toReturn = (0, typescript_utils_1.replaceNode)('', inputText, node, '');
    });
...
function purgeDeepLinkImport(inputText) {
    var sourceFile = (0, typescript_utils_1.getTypescriptSourceFile)('', inputText);
    var importDeclarations = (0, typescript_utils_1.findNodes)(sourceFile, sourceFile, typescript_1.SyntaxKind.ImportDeclaration);
        ...
        if (importDeclaration.moduleSpecifier
            ...
            if (decoratorIsImported_1) {
                if (namedImportStrings_1.length) {
                    ...
                    inputText = (0, typescript_utils_1.replaceNode)('', inputText, importDeclaration.importClause.namedBindings, namedImportString);
                }
                else {
                    // remove the entire import statement
                    inputText = (0, typescript_utils_1.replaceNode)('', inputText, importDeclaration, '');
                }
            }
        }
    });
...
function getInjectDeepLinkConfigTypescriptTransform() {
    var deepLinkString = convertDeepLinkConfigEntriesToString((0, helpers_1.getParsedDeepLinkConfig)());
    var appNgModulePath = (0, helpers_1.toUnixPath)((0, helpers_1.getStringPropertyValue)(Constants.ENV_APP_NG_MODULE_PATH));
    ...
    function visitDecoratorNode(decorator, sourceFile) {
        if (decorator.expression && decorator.expression.expression && decorator.expression.expression.text === typescript_utils_1.NG_MODULE_DECORATOR_TEXT) {
            ...
            if (updatedArgs.length === 1) {
                updatedArgs.push((0, typescript_1.createIdentifier)('{ }'));
            }
            if (updatedArgs.length === 2) {
                updatedArgs.push((0, typescript_1.createIdentifier)(deepLinkString));
            }
            functionCall = (0, typescript_1.updateCall)(functionCall, functionCall.expression, functionCall.typeArguments, updatedArgs);
